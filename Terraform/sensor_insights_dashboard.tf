      ...
      # AQI with Health Categories - Stacked View
      {
        ...
        properties = {
          metrics = [
            ...
            [".", "GoodAirQuality", ".", ".", ".", ".", { "color": "#4CAF50", "label": "Good (0-50)" }],
            [".", "ModerateAirQuality", ".", ".", ".", ".", { "color": "#FFEB3B", "label": "Moderate (51-100)" }],
            [".", "UnhealthyAirAlert", ".", ".", ".", ".", { "color": "#FF5722", "label": "Unhealthy (101-150)" }]
          ]
          view    = "timeSeries"
          stacked = false
          region  = "us-east-1"
